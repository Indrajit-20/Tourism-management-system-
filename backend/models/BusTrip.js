...
const BusTripSchema = new mongoose.Schema(
  {
    ...
    seats: [
      {
        ...
        type: {
          type: String,
          enum: ["window", "aisle", "middle", "sleeper"],
          default: "aisle",
        },
    ...
    // ✅ NEW: Flag to mark this as a return/reverse trip
    is_return_trip: { type: Boolean, default: false },

    // ✅ NEW: Link to the forward trip (for return trips only)
    related_trip_id: {
      type: mongoose.Schema.Types.ObjectId,
      ref: "BusTrip",
    },
